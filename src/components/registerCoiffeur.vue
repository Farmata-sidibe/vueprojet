     ...
     <div class="container">
            ...
            <div >
                ...
                <form @submit.prevent="doregister" class="forme">
                    ...
                    <button class="inscrit">S'inscrire</button>
...
export default {
    ...
    methods:{
        doregister: function (){
            this.axios.post("http://localhost:3000/coiffeur/register",{
                email:this.email,
...
/* une fois les donnes recperer et stockés il va nous renvoyer sur home */
                    this.$router.push({name: 'registerSalon'})
                    window.location.reload();
                }
                else{
                    this.$router.push({name: "registerSalon", params: {msg: "non connecté"} })
                }
            })
            .catch(err => {
                console.log(err);
...
<style scoped>
.plan {
    background-image: url("../assets/image-register-salon.jpg") ;
    margin: 0 ;
  padding: 0;
