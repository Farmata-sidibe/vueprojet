...
<h5 class="adres">16 Rue Mail Mendes, Paris</h5>
<button class="rdv">Prendre RDV</button>
<img src="../assets/salon-la-parisienne.jpg" alt="" class="imgsalon">
...
.search2{
    border: none;
    border-radius: 9px;
    border-left: 5px solid #3a2b3b;
    background: #7F6E6F;
    box-shadow: 2px 2px 2px #1f1220;
    outline: none;
    height: 44px;
    width: 24%;
    margin-bottom: 15px;
