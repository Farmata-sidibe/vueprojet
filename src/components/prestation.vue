...
<carousel>
  ...
  <slide>
    <a href="/Produit"><img src="../assets/gamme-jamaican-black-castor-oil_produit.jpg" alt="" class="imgsli"></a>
  </slide>
...
.imgsli{
    ...
    left: 8%;
    border-radius: 23px;
    box-shadow: 7px -6px 5px -1px #1f1220;
